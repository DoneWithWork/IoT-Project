...
-- AddForeignKey
ALTER TABLE "DataPoint" ADD CONSTRAINT "DataPoint_dataStreamId_fkey" FOREIGN KEY ("dataStreamId") REFERENCES "DataStream"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
